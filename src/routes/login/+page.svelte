        ...
        {:else}
          <div class="text-center py-4">
            <div class="w-14 h-14 mx-auto mb-4 rounded-full bg-rose-50 flex items-center justify-center">
              <svg class="w-7 h-7 text-rose-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
              </svg>
            </div>
            <h2 class="text-lg font-medium text-gray-800 mb-1">Welcome back</h2>
            <p class="text-sm text-gray-400 mb-6">Sign in with your account to continue</p>

            {#if form?.error}
              <div class="bg-red-50 text-red-600 text-sm rounded-xl px-4 py-3 mb-4">{form.error}</div>
            {/if}
